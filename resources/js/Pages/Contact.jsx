...
export default function Contact() {
    ...
    return (
        <PublicLayout title="Contact Us - Serve Cafe">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                    <div className="text-center">
                        ...
                        <p className="text-xl md:text-2xl max-w-3xl mx-auto text-white/90">
                            ...
                            about our services, membership, or technical support.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300 text-center">
                            ...
                            <h3 className="text-2xl font-bold mb-4 text-gray-900">Live Chat</h3>
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                Chat with our support team in real-time for instant help.
                            </p>
                            <button className="text-yellow-600 font-semibold text-lg hover:underline">
                                Start Chat
                            </button>
                            <div className="mt-4 text-sm text-gray-500">
                                Instant responses
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300 text-center">
                            ...
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                Come to our headquarters for in-person support and assistance.
                            </p>
                            <p className="text-green-600 font-semibold text-center">
                                Lalitpur 14 Khumaltar<br />
                                Kathmandu, Nepal
                            </p>
                            <div className="mt-4 text-sm text-gray-500">
                                Mon-Fri: 9AM-6PM
                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold text-gray-900 mb-1">Support Availability</h3>
                                        <p className="text-gray-600">
                        ...
                        <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
                            <div className="h-96 bg-gradient-to-br from-red-100 to-orange-100 flex items-center justify-center">
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-600">
                                        Click to view our location on Google Maps<br />
                                        and get directions to our office.
                                    </p>
                                    <button className="mt-4 btn bg-red-600 text-white hover:bg-red-700 px-6 py-2 rounded-full">
                                        View on Maps
                                    </button>
                                </div>
                            </div>
            ...
            <div className="py-24 bg-gradient-to-br from-red-600 via-red-700 to-orange-600 text-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-12 text-white/90">
                        Start your journey with us today and become part of our growing community 
                        of satisfied members and successful entrepreneurs.
                    </p>
