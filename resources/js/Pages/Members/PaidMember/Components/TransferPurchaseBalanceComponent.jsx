...
export default function TransferPurchaseBalanceComponent({
    isOpen,
    onClose,
    currentBalance = 0,
    onTransferSuccess,
    ...
    useEffect(() => {
        ...
        if (isNaN(transferAmount) || transferAmount <= 0) {
            setValidationMessage("Please enter a valid transfer amount.");
            return;
        }
    ...
    const handleSubmit = (e) => {
        ...
        // Final validation
        if (!data.amount || isNaN(transferAmount) || transferAmount <= 0) {
        ...
        post(route("transfer.purchase.balance"), {
            onSuccess: (page) => {
            ...
            onError: (errors) => {
                setError(
                    errors.message ||
                        "An error occurred while processing transfer."
                );
            },
            onFinish: () => {
                ...
                <div className="mt-3">
                    ...
                    <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                        ...
                        <div className="mt-2 text-xs text-gray-500">
                            This amount will be transferred to your purchase
                            wallet
                        </div>
                    </div>
