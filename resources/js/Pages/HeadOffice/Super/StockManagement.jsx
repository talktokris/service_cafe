...
import ManageStockRecordComponents from "../../StockRecordComponents/ManageStockRecordComponents";
...
export default function StockManagement({
    ...
    return (
        <AdminDashboardLayout title="Stock Management - Serve Cafe" user={user}>
            ...
            {/* Stock Records Management Component */}
            <ManageStockRecordComponents
                user={user}
