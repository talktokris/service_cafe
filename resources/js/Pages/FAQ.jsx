...
export default function FAQ() {
    ...
    return (
        <PublicLayout title="Frequently Asked Questions - Serve Cafe">
            <Head title="FAQ" />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                    <div className="text-center">
                        ...
                        <p className="text-xl md:text-2xl max-w-3xl mx-auto text-white/90">
                            Find answers to common questions about Serve Cafe's services, 
                            digital wallet, and referral program.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <div className="relative max-w-2xl mx-auto">
                            ...
                            />
                            <button className="absolute right-3 top-1/2 transform -translate-y-1/2 bg-red-600 text-white p-3 rounded-full hover:bg-red-700 transition-colors">
                        ...
                        <p className="text-gray-600 mt-4">
                            Can't find what you're looking for? <a href="/contact" className="text-red-600 hover:underline">Contact our support team</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Explore these additional resources or get in touch with our support team.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
                            ...
                            <h3 className="text-xl font-bold mb-4 text-gray-900">User Guide</h3>
                            <p className="text-gray-600 mb-6">
                                Comprehensive guides and tutorials to help you get the most out of Serve Cafe.
                            </p>
                            <a href="/guide" className="btn bg-red-600 text-white hover:bg-red-700 px-6 py-2 rounded-full">
                                View Guide
                            </a>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
                            ...
                            <p className="text-gray-600 mb-6">
                                Chat with our support team in real-time for immediate assistance and answers.
                            </p>
                            <button className="btn bg-orange-600 text-white hover:bg-orange-700 px-6 py-2 rounded-full">
                                Start Chat
                            </button>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
                            ...
                            <h3 className="text-xl font-bold mb-4 text-gray-900">Email Support</h3>
                            <p className="text-gray-600 mb-6">
                                Send us detailed questions and receive comprehensive responses from our team.
                            </p>
                            <a href="mailto:support@servecafe.com" className="btn bg-yellow-600 text-white hover:bg-yellow-700 px-6 py-2 rounded-full">
                                Send Email
                            </a>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
                            ...
                            <h3 className="text-xl font-bold mb-4 text-gray-900">Phone Support</h3>
                            <p className="text-gray-600 mb-6">
                                Call our support hotline for urgent matters and direct assistance from our team.
                            </p>
                            <a href="tel:+9779766389515" className="btn bg-green-600 text-white hover:bg-green-700 px-6 py-2 rounded-full">
                                Call Now
                            </a>
                        </div>
                    </div>
