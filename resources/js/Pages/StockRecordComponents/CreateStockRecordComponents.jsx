...
export default function CreateStockRecordComponents({
    onClose,
    onSuccess,
    officeProfiles = [],
    stockItemSettings = [],
        ...
        try {
            ...
            router.post("/stock-records", formData, {
                onSuccess: (page) => {
                    ...
                    console.log(
                        "stockRecord in props:",
                        page.props.stockRecord
                    );
                    // Call the success callback with the new stock record data
                    if (page.props.stockRecord) {
                        console.log(
                            "Using stockRecord from page props:",
                            page.props.stockRecord
                        );
                        onSuccess(page.props.stockRecord);
                    } else {
                        // If no stock record data in response, create a mock stock record for the callback
                        ...
                        console.log("Using mock stock record:", newStockRecord);
                        onSuccess(newStockRecord);
                    }
                },
                onError: (errors) => {
                    setErrors(errors);
