...
export default function DeleteStockRecordComponents({
    stockRecord,
    onClose,
    onSuccess,
}) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            router.delete(`/stock-records/${stockRecord.id}`, {
                onSuccess: (page) => {
                    // Show success message
                    if (page.props.flash?.success) {
                        console.log(page.props.flash.success);
                    }
                    onSuccess(stockRecord.id);
                },
                onError: (errors) => {
                    console.error("Error deleting stock record:", errors);
                },
                onFinish: () => {
                    setIsDeleting(false);
                },
                ...
                <div className="p-6">
                    ...
                    <div className="text-center mb-6">
                        ...
                        <p className="text-sm text-gray-500">
                            This action will mark the stock record as deleted.
                        ...
                        <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                                <span className="text-gray-600">
                                    Stock Item Setting ID:
                                </span>
                                <span className="font-medium">
                                    {stockRecord.stockItemSettingId || "N/A"}
                                </span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-gray-600">
