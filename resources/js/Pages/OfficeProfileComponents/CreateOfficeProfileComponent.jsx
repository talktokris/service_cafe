...
export default function CreateOfficeProfileComponent({ onClose, onSuccess }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            router.post("/office-profiles", formData, {
                onSuccess: (page) => {
                    // Show success message
                    if (page.props.flash?.success) {
                        console.log(page.props.flash.success);
                    }
                    // Call the success callback with the new profile data
                    if (page.props.officeProfile) {
                        onSuccess(page.props.officeProfile);
                    } else {
                        // If no profile data in response, create a mock profile for the callback
                        const newProfile = {
            ...
            console.error("Error creating office profile:", error);
            setIsSubmitting(false);
        }
    };
