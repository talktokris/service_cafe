...
export default function CreateRestaurantTableComponent({
    onClose,
    onSuccess,
    officeProfiles = [],
}) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            router.post("/restaurant-tables", formData, {
                onSuccess: (page) => {
                    ...
                    // Call the success callback with the new table data
                    if (page.props.restaurantTable) {
                        console.log(
                            "Using restaurantTable from page props:",
                            page.props.restaurantTable
                        );
                        onSuccess(page.props.restaurantTable);
                    } else {
                        // If no table data in response, create a mock table for the callback
                        const newTable = {
                        ...
                        console.log("Using mock table:", newTable);
                        onSuccess(newTable);
                    }
                },
                onError: (errors) => {
