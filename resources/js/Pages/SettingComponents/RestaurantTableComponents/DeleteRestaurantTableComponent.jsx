...
export default function DeleteRestaurantTableComponent({
    table,
    onClose,
    onSuccess,
}) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            router.delete(`/restaurant-tables/${table.id}`, {
                onSuccess: (page) => {
                ...
                onError: (errors) => {
                    console.error("Error deleting restaurant table:", errors);
                },
                onFinish: () => {
                    setIsDeleting(false);
                },
                ...
                <div className="p-6">
                    ...
                    <div className="text-center mb-6">
                        ...
                        <p className="text-sm text-gray-500">
                            This action will mark the table as deleted. This
